...
object GoogleVsApple {
  ...
  lazy val googleTweets: TweetSet = allTweets.filter(x => google.exists(x.text.contains(_)))
  lazy val appleTweets: TweetSet = allTweets.filter(x => apple.exists(x.text.contains(_)))
